<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-greyb" 
	...
	<?php
		if(isset($_GET['ptid']) && isset($_GET['fnm'])
			...
			echo "<a href='studentinfo.php?ptid=".$iden."&fnm=".$fnen."&gnm=".$gnen."&h=st' class='w3-bar-item ".$st." w3-button w3-hover-green'>Application Form</a>
			<a href='reference.php?ptid=".$iden."&fnm=".$fnen."&gnm=".$gnen."&h=rf' class='w3-bar-item ".$rf." w3-button w3-hover-green'>Reference</a>
			<a href='evidence.php?ptid=".$iden."&fnm=".$fnen."&gnm=".$gnen."&h=ev' class='w3-bar-item ".$ev." w3-button w3-hover-green'>Evidence</a>";
		}
	?>
</div>